...
public class Reporte3 {
	...
	// Pais pais;
	//
	// HashTableAbierto<Pais, Producto> hashProductoDePaisesHAB = new
	// HashAbierto<>(1000);
	// HashTableAbierto<Pais, Producto> hashProductoDePaises = new
	// HashAbierto<>(1000);
	...
	// }
	// }
	// Iterator<MiListaEnlazada<NodoHash<Pais, Producto>>> iteratorHashHAB =
	// hashProductoDePaisesHAB.iterator();
	// Iterator<MiListaEnlazada<NodoHash<Pais, Producto>>> iteratorHash =
	// hashProductoDePaises.iterator();
